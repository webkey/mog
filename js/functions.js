...
function fileInput() {
	$('.upload-file').each(function () {
		...
		$(this).filer({
			limit: null,
			maxSize: null,
			changeInput: '<div class="jFiler-input-dragDrop"><div class="jFiler-input-inner"><div class="jFiler-input-icon"><i class="icon-jfi-cloud-up-o"></i></div><div class="jFiler-input-text"><h3>Перетащите файл или кликните по полю</h3></div></div></div>',
			showThumbs: true,
			theme: "dragdropbox",
			captions: {
				button: "Choose Files",
